...
MIDDLEWARE = [
    ...
    'admin.middlewares.SetLastUserLogin',
    'admin.middlewares.PutDeleteMethodInRequestContext',
]
...
WSGI_APPLICATION = 'AlumniSite.wsgi.application'
